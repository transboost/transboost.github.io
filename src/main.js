...
import { createRouter, createWebHashHistory } from "vue-router"; // Se podria poner createWebHashHistory
...
const router = createRouter({
  history: createWebHashHistory(), // Se podria poner createWebHashHistory
  routes,
});
